...
{*****************************************************************************}
{
  ...
  strings with calls to Drago translation function U(''):

  srNone = '(empty)'; NO: OnPaint not visible
  SPictureLabel = 'Image:';
...
begin
  ...
  begin
    ...
    begin
      FPictureLabel.Caption := U('Image:'); ///SPictureLabel
...
begin
  ...
  try
    ...
    Visible := False;
    Caption := U('Preview2'); ///SPreviewLabel
    KeyPreview := True;
